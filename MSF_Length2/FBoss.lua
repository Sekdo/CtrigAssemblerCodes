...
CIf(FP,{CVar("X",GMode,AtLeast,2),CDeaths("X",Exactly,1,CacheEnd)})
	...
	CTrigger(FP,{ -- Dash On
		...
		SetCDeathsX("X",SetTo,34*3,FB_Dash,0xFFFF);
		SetCDeathsX("X",SetTo,1*65536,FB_Dash,0xFF0000);
		SetMemory(0x657470+4*99,SetTo,1); -- 최대사거리 1
...
NIf(FP,{Memory(0x628438,AtLeast,1),CDeaths("X",Exactly,1,CacheEnd)},{SetSpriteImage(385,EFImage2),SetImageScript(EFImage2,131)})
	...
	CIf(FP,{CVar("X",GMode,AtLeast,2)})
		CIf(FP,{CDeaths("X",Exactly,1,FB_PhaseNumber)})
		...
		CIf(FP,{CDeaths("X",AtLeast,2,FB_PhaseNumber)})
			CreateEffect(FP, Nextptr, 17, EFImage2, 20, 204, "CLoc135", P8)
		CIfEnd()
	CIfEnd()
...
TriggerX(FP,{CVar("X",GMode,Exactly,3)},{CreateUnit(1,30,"CLoc144",P8),CreateUnit(1,13,"CLoc144",P8)},{Preserved})
...
CIf(FP,{CVar("X",GMode,AtLeast,2)})
	...
	CIf(FP,{CDeaths("X",Exactly,5,PH_Stage)},{SetCDeaths("X",SetTo,6,PH_Stage),SetCDeaths("X",SetTo,34*10,PH_Timer)})
	
		CIf(FP,{CDeaths("X",Exactly,0,FB_ClearPattern),CDeaths("X",Exactly,34*10,PH_Timer)})
			DoActionsX(FP,{
				CreateUnit(1,84,"FBLoc1",P8);
...
CIf(FP,{CVar("X",GMode,AtLeast,2)})
	...
	CIf(FP,{CDeaths("X",Exactly,2,PH_Stage)})
		...
		CreateBullet(FP,P8,198,3,BlastAngle,12000,10,"FBLoc1") -- 즉사
			CIf(FP,{CVar("X",GMode,Exactly,3)})
				CreateBullet(FP,P8,198,3,BlastAngle2,12000,10,"FBLoc1") -- 즉사
			CIfEnd()
	...
	CIf(FP,{CDeaths("X",Exactly,1,SideUnitSetting)},{SetCDeaths("X",Add,1,PH5_Side)})
		...
		CIfEnd()
		CIf(FP,{CVar("X",GMode,Exactly,3)})
			TriggerX(FP,{CDeaths("X",Exactly,1,PH5_Side)},{SetNVar(FUV[9],SetTo,86),SetNVar(FUV[10],SetTo,27)},{Preserved})
			TriggerX(FP,{CDeaths("X",Exactly,2,PH5_Side)},{SetNVar(FUV[9],SetTo,98),SetNVar(FUV[10],SetTo,58)},{Preserved})
			TriggerX(FP,{CDeaths("X",Exactly,3,PH5_Side)},{SetNVar(FUV[9],SetTo,88),SetNVar(FUV[10],SetTo,8)},{Preserved})
		CIfEnd()
